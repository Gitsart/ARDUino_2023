...
//high speed setting//
int high_spd = 40;          //40     
int high_spd_high = 50;   //50
int high_spd_low =30;   //30
...
//slow speed setting//
int slow_spd =  10;    //was20
int slow_spd_high = 20;  //was30
int slow_spd_low = 5; //was10
...
void push_button()
{
  if  ((digitalRead(front_pb) == LOW) && (digitalRead(back_pb) == HIGH) && battery_low == false && Start_process == false && pause == false && Back_Start_process == false )
  {
    front_cam = true;
    back_cam = false;
    count = 0;
  ...
  else if ((digitalRead(front_pb) == HIGH) && (digitalRead(back_pb) == LOW)  && battery_low == false && Back_Start_process == false && pause == false && Start_process == false)
  {
    front_cam = false;
    back_cam = true;
    count = 0;
  ...
  else if  ((digitalRead(front_pb) == LOW) && (emg == true) && pause == false && Start_process == true)
  {
  ...
  else if  ((digitalRead(back_pb) == LOW) && (emg == true)&& pause == false && Back_Start_process == true)
  {
  ...
  else if  ((digitalRead(front_pb) == LOW) && (pause == true) && Back_Start_process == true)
  {
    emg = false;
    op_ack = true;
     pause = false;
  ...
  else if  ((digitalRead(back_pb) == LOW) && (pause == true) && Start_process == true )
  {
    emg = false;
     pause = false;
    op_ack = true;
...
void forward_motion()
{
  if (signature == 1&& signature == 3 && signature ==4)
  {
    pause = false;
    }
...
void reverse_motion()
{
  if (signature_b == 1&& signature_b == 3 && signature_b==4)
  {
    pause = false;
    }
...
void loop()
{
  ...
  Serial.print("camerror"); Serial.println(cameraerror);                                              
  Serial.print("front_cam"); Serial.println(front_cam);
  Serial.print("back_cam"); Serial.println(back_cam);
